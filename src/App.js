...
function App() {
  ...
  const [themeSelected, setThemeSelected] = useState(sessionStorage.getItem("theme") || "light");
  ...
  return (
    <ThemeProvider theme={tema}>
      <AppRouter themeSelected={themeSelected} setThemeSelected={setThemeSelected}   />
    </ThemeProvider>
  );
}
