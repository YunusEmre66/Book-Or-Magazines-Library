...
import { HeaderButton, HeaderContainer, HeaderForm, HeaderTitle, SearchInput, SelectInput } from './Header.style'
  ...
  return (
    <HeaderContainer>
      ...
      <HeaderForm onSubmit={handleSubmit}>
        <SearchInput type="text" placeholder='Search Book or Magazine' onChange={(e)=>setQuery(e.target.value)}/>
